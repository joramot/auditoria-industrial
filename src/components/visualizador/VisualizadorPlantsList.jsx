/**
 * VisualizadorPlantsList.jsx - Lista de Plantas para Visualizador
 * Muestra todas las plantas con progreso y acceso a equipos
 * Basado en AuditorPlantsList pero con textos adaptados para consulta
 *
 * @version 1.0.0
 */
...
/**
 * Componente de Lista de Plantas para Visualizador
 *
 * @param {Object} props
    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
      ...
      <div className="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-purple-600 to-purple-700">
        ...
        <p className="text-sm text-purple-100 mt-1">
          Selecciona una planta para Consultar sus equipos
        </p>
      </div>
                  ...
                  {hasEquipment ? (
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className={`text-sm font-semibold ${isComplete ? 'text-green-600' : 'text-purple-600'}`}>
                          {progress}%
                        </span>
                      </div>
...
export default VisualizadorPlantsList;
