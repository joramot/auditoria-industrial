...
import { deleteFactura, deletePedimento } from "./deletionService_INTEGRATED";

/**
 * ðŸ“„ PDF UPLOADER COMPONENT CON FUNCIONALIDAD DE ELIMINACIÃ“N
 * 
 * Componente para seleccionar, validar, subir y ELIMINAR archivos PDF
 * Soporta facturas y pedimentos
 * 
 * @version 2.0 - Con eliminaciÃ³n integrada
 */
...
const PDFUploader = ({
  ...
  equipmentId,                 // ID del equipo (para eliminaciÃ³n)
  isOnline = true,             // Estado de conexiÃ³n
  maxPDFs = 5,                 // MÃ¡ximo de PDFs por categorÃ­a
  maxSizeMB = 20,              // TamaÃ±o mÃ¡ximo en MB
  disabled = false,
}) => {
  ...
  /**
   * ðŸ—‘ï¸ ELIMINAR PDF - NUEVA FUNCIÃ“N
   */
  const handleDeletePDF = async (index) => {
    ...
    try {
      ...
      // Si ya estÃ¡ sincronizado, usar funciÃ³n de eliminaciÃ³n
  ...
  /**
   * Eliminar PDF (mantener funciÃ³n original para PDFs nuevos)
   */
